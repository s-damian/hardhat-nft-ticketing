        ...
        <Layout>
            <div className="flex flex-col items-center justify-center bg-gray-100">
                ...
                <p className="text-lg text-gray-700 mb-8 text-center max-w-2xl">
                    Notre plateforme, basée sur la blockchain Ethereum, permet aux organisateurs d'événements de créer des événements uniques et de vendre des
                ...
                <div className="flex flex-wrap justify-center gap-8">
                    <div className="bg-white rounded-lg shadow-lg p-6 max-w-xs">
                        ...
                        <Link
                            href="/create-event"
                            className="block text-center py-2 px-4 bg-indigo-600 text-white rounded-lg hover:bg-indigo-600 transition duration-300"
                        >
                            Créer un Événement
                        </Link>
                    </div>
                ...
                <div className="mt-12 text-center">
                    ...
                    <Link
                        href="/create-event"
                        className="inline-block py-2 px-6 bg-indigo-600 text-white rounded-lg hover:bg-indigo-600 transition duration-300"
                    >
                        Commencer
                    </Link>
                </div>
